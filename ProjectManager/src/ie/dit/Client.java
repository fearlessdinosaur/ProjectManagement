...
public class Client {
    ...
    String getTeam(String TeamName, String admin) throws JSONException, UnsupportedEncodingException {
        String info;
        int code = 101;
        String url = "http://192.168.192.46:8082?Teamname=" + TeamName + "&pass=" + pass + "&code=" + code;
        info=find(url);
        return info;
    }
